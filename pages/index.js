    ...
    <Layout>
      ...
      <main className={styles.container}>
        ...
        <div className={styles.right}>
          ...
          <p>When I am not creating I love exploring the many cafes & views of Seattle, <a href="https://www.goodreads.com/user/show/113843935-nivrithi">diving into a new book</a> (or pool!), and capturing moments through my digital camera. </p>
